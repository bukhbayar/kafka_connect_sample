...
CREATE USER c##logminer IDENTIFIED BY dbz DEFAULT TABLESPACE LOGMINER_TBS QUOTA UNLIMITED ON LOGMINER_TBS CONTAINER=ALL;
...
GRANT SELECT ON V_$TRANSACTION TO c##logminer CONTAINER=ALL;
